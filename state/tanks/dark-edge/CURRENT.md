...
Dark Edge keeps overload geometry, grass scoring, wall handling, and gunline frame economy unchanged. This iteration only bounds grass-control candidate scans to nearby pressure grass before pathing to protect runtime budget.
