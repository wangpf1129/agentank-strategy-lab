...
Goal: shield-main / 500 / boost stable 2600. Axis: v61 boost-only behavior tree reset is published. Next validation should use a small real batch with stop-loss and check boost free-turn value before further code changes.
