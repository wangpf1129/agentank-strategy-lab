...
function usage() {
  return [
    "Usage:",
    "  node lab/scripts/fetch-tank-snapshot.mjs <codename> <key-env-var> [output-root]",
    "",
    "Examples:",
    "  AGENTANK_FREEZE_KEY=<key> node lab/scripts/fetch-tank-snapshot.mjs freeze-main AGENTANK_FREEZE_KEY",
    "  AGENTANK_TELEPORT_KEY=<key> node lab/scripts/fetch-tank-snapshot.mjs teleport-main AGENTANK_TELEPORT_KEY",
  ].join("\n");
}
...
const outputRoot = process.argv[4] ?? "/tmp/agentank-runs/fleet";
