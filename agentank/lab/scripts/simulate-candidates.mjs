...
function usage() {
  return [
    "Usage:",
    "  node agentank/lab/scripts/simulate-candidates.mjs --code <tank=path> [options]",
    "",
    "Options:",
    ...
    "  --output-root <path>        Output root. Default: agentank/lab/data/simulations",
    "",
    "Examples:",
    "  AGENTANK_FREEZE_KEY=<key> AGENTANK_TELEPORT_KEY=<key> node agentank/lab/scripts/simulate-candidates.mjs --code freeze-main=agentank/tank-captain-freeze-control-v7-candidate.js --code teleport-main=agentank/teleport-main-v6-candidate.js",
    "",
...
async function main() {
  ...
  const outputRoot = readOption(argv, "--output-root", "agentank/lab/data/simulations");
