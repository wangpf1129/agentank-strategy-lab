...
function usage() {
  return [
    ...
    "  --output-dir <path>            Replay output dir. Default: lab/data/matches",
    "  --run-dir <path>               Run log dir. Default: lab/data/challenge-runs",
...
const outputDir = readOption(argv, "--output-dir", "lab/data/matches");
const runDir = readOption(argv, "--run-dir", "lab/data/challenge-runs");
